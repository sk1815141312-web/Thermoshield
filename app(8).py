...
def build_map(origin, destination, route_options, selected_name):
    ...
    # Explicit no-key raster tile URL — folium's "CartoDB dark_matter" shortcut
    # can sometimes resolve to a newer Carto endpoint that requires an API
    # key. This raw XYZ tile pattern is the classic, always-free CartoDB
    # dark basemap and needs no key.
    fmap = folium.Map(
